...
public class MengenalHewan extends Activity {
    private int a = 0;
    private int b = 0;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mengenal_hewan);
        ...
        menu.setOnClickListener(new ImageButton.OnClickListener() {
            public void onClick(View v) {
                MengenalHewan.this.openOptionsMenu();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == 1) {
            ...
            tallash.setClass(MengenalHewan.this, TebakAngka.class);
            MengenalHewan.this.startActivity(tallash);
